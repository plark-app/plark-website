...
export default React.memo(function PartnerList(props: PartnerListProps): JSX.Element {
    return (
        <div className={cn(styles.list, { [styles.isSmall]: props.isSmall }, props.className)}>
            <KunaLogoSvg className={cn(styles.partner, styles.isKuna)} />
            <ChangellyLogoSvg className={cn(styles.partner, styles.isChangelly)} />
            <ZeroHubLogoSvg className={cn(styles.partner, styles.isZerohub)} />
            <CoinswitchLogoSvg className={cn(styles.partner, styles.isCoinswitch)} />
            <WalletTopupLogoSvg className={cn(styles.partner, styles.isWallettopup)} />
        </div>
    );
});
